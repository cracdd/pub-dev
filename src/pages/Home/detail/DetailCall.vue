<template>
  <ul class="callDetail-tab">
    <li
      class="tab tab1"
      :class="{ active: activeCallDetailTab == 'callDetail' }"
      @click="activeCallDetailTab = 'callDetail'"
    >
      통화 상세정보
    </li>
    <li
      class="tab tab2"
      :class="{ active: activeCallDetailTab == 'summationDetail' }"
      @click="activeCallDetailTab = 'summationDetail'"
    >
      상담 요약
    </li>
  </ul>
      ...
      <div class="IncidentType">
        ...
        <div class="case-select">
          <ul>
            ...
            <li
              data-toggle="modalPopup"
              data-target="#modalTest2"
              @click="openPopupDirect()"
            >
              직접선택
            </li>
            <li></li>
      ...
      >
        <div class="form-col-wrap type-column summary-item">
          ...
          <dl class="form-col">
            <dt>
              <i
                ><img src="../../../assets/images/ico-summary1.svg" alt=""
              /></i>
              <span>상담 주제</span>
            </dt>
            <dd>
              <ul class="box-item">
                <li>
                  고객과 상대방이 오토바이 사고 이후 보험 처리와 관련된 책임
                  소재를 두고 서로 상반된 주장을 하고 있음. 고객은 본인이 보험
                  접수를 요청한 적이 없다고 주장하는 반면, 상대방은 고객이
                  현장에서 책임을 인정하고 보험 처리를 하기로 했다고
                  주장함.고객과 상대방이 오토바이 사고 이후 보험 처리와 관련된
                  책임 소재를 두고 서로 상반된 주장을 하고 있음. 고객은 본인이
                  보험 접수를 요청한 적이 없다고 주장하는 반면, 상대방은 고객이
                  현장에서 책임을 인정하고 보험 처리를 하기로 했다고 주장함.
                </li>
              </ul>
            </dd>
          </dl>
          <dl class="form-col">
            <dt>
              <i
                ><img src="../../../assets/images/ico-summary2.svg" alt=""
              /></i>
              <span>고객 내용 요약</span>
            </dt>
            <dd>
              <ul class="box-item">
                <li>
                  고객은 상대방에게 개인 합의가 가능한지 문의했으나 거절당함.
                </li>
                <li>
                  고객은 사고 당시 KB손해보험을 통해 처리하자고 제안했으나,
                  상대방이 이를 거 절.하고 다른 방식으로 처리하려 했다고 주장함.
                </li>
                <li>
                  고객은 상대방에게 개인 합의가 가능한지 문의했으나 거절당함.
                </li>
          ...
          <dl class="form-col">
            <dt>
              <i
                ><img src="../../../assets/images/ico-summary3.svg" alt=""
              /></i>
              <span>상담사 내용 요약</span>
            </dt>
            <dd>
              <ul class="box-item">
                ...
                <li>
                  상대방은 우리 보험사에 100% 다 처리 받으라고 이야기 들었다고
                  주장함.
                </li>
                <li>
                  상담사는 상대방과 연락하여 상황을 명확히 할 것을 제안함.
                </li>
              </ul>
            </dd>
          </dl>
...
<script setup>
  ...
  const { detailData, detailType, isVisible } = storeToRefs(
    useDetailViewStore(),
  );
